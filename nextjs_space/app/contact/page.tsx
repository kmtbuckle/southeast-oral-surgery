// nextjs_space/app/contact/page.tsx
import { MapPin, Phone, Clock } from 'lucide-react';
import type { Metadata } from 'next';
import ConsultationForm from '@/components/consultation-form';
import { Button } from '@/components/ui/button';
import HashScroll from './scroll-to-hash';
...
export default function ContactPage() {
  return (
    <div className="bg-white">
      {/* This client component handles scrolling when arriving on /contact#consultation-form */}
      <HashScroll />
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="mt-4 flex items-center space-x-3">
                    ...
                    <a href={`tel:${location.phoneRaw}`} className="text-lg font-medium text-primary hover:underline">
                      {location.phone}
                    </a>
                  </div>

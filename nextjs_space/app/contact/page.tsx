...
export const metadata: Metadata = {
  ...
  description: 'Contact our Charlotte and Albemarle offices for consultations, appointments, and inquiries. Two convenient locations to serve you.',
};
      ...
      <section className="bg-gradient-to-b from-stone-50 to-white py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm font-medium uppercase tracking-widest text-primary/70">Two Locations</p>
            ...
            {locations?.map?.((location, index) => (
              ...
              >
                ...
                <div className="aspect-video w-full bg-gray-100">
                  <iframe
                    src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3000!2d-80.8!3d35.1!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2s${encodeURIComponent(location?.address?.street + ', ' + location?.address?.city + ', ' + location?.address?.state)}!5e0!3m2!1sen!2sus!4v1600000000000!5m2!1sen!2sus`}
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
